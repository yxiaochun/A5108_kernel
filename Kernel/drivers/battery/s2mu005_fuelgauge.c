...
static int s2mu005_get_soc_from_ocv(struct s2mu005_fuelgauge_data *fuelgauge, int target_ocv)
{
	...
	int soc_arr_evt1[TABLE_SIZE] = {10200,9713,9226,8739,8251,7763,7276,6788,6301,5813,5326,4838,4351,3863,3376,2888,2400,1913,1425,937,450,-38}; // * 0.01%
	int ocv_arr_evt1[TABLE_SIZE] = {43567,43012,42457,41902,41383,40881,40469,39790,39578,39211,38716,38395,38177,38009,37875,37765,37629,37432,37185,36911,36750,32751}; // *0.1mV

	/* 22 values of mapping table for EVT2*/
	int soc_arr_evt2[TABLE_SIZE] = {10010,9532,9055,8577,8099,7621,7144,6666,6188,5711,5233,4755,4277,3800,3322,2844,2366,1889,1412,934,456,-21}; // * 0.01%
	int ocv_arr_evt2[TABLE_SIZE] = {44094,43474,42855,42263,41680,41128,40613,40147,39728,39302,38771,38462,38231,38043,37899,37782,37622,37411,37120,36858,36699,33173}; // *0.1mV
...
{
	int i;
	u8 table1[88] = {0x7b,0x0a,0xf7,0x09,0x85,0x09,0x1b,0x09,0xb4,0x08,
	...
	u8 table2[22] = {0x2d,0x2d,0x2d,0x2e,0x2e,0x2f,0x2d,0x2f,0x2f,0x2e,
					0x2f,0x2e,0x2e,0x2f,0x2e,0x2e,0x2f,0x2f,0x2f,0x2e,
					0x2f,0x9a,
	};

	u8 table3[88] = {0x46,0xb,0xc7,0xa,0x49,0xa,0xcf,0x9,0x58,0x9,
					0xe7,0x8,0x7e,0x8,0x1e,0x8,0xc8,0x7,0x71,0x7,
					0x4,0x7,0xc5,0x6,0x96,0x6,0x6f,0x6,0x52,0x6,
					0x3a,0x6,0x19,0x6,0xee,0x5,0xb2,0x5,0x7c,0x5,
					0x5c,0x5,0x8a,0x2,0x2,0x8,0xa0,0x7,0x3e,0x7,
					0xdd,0x6,0x7b,0x6,0x19,0x6,0xb7,0x5,0x55,0x5,
					0xf3,0x4,0x92,0x4,0x30,0x4,0xce,0x3,0x6c,0x3,
					0xa,0x3,0xa8,0x2,0x46,0x2,0xe5,0x1,0x83,0x1,
					0x21,0x1,0xbf,0x0,0x5d,0x0,0xfc,0xf,
	};
	u8 table4[22] = {0x39,0x36,0x34,0x33,0x35,0x32,0x32,0x34,0x33,
					0x34,0x33,0x35,0x36,0x38,0x37,0x36,0x39,0x3d,
					0x38,0x39,0x3b,0x10,
	};
	...
	s2mu005_write_reg_byte(fuelgauge->i2c, 0x0F, 0x20);
	s2mu005_write_reg_byte(fuelgauge->i2c, 0x0E, 0x08);
	s2mu005_write_reg_byte(fuelgauge->i2c, 0x11, 0x08);
	s2mu005_write_reg_byte(fuelgauge->i2c, 0x10, 0x02);
