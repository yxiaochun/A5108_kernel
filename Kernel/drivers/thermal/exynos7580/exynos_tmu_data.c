...
#ifdef CONFIG_EXYNOS7580_TMU_DATA_GV
#define EXYNOS7580_TMU_DATA_CL0 \
	.trigger_levels[0] = 76, \
	.trigger_levels[1] = 81, \
	.trigger_levels[2] = 86, \
	.trigger_levels[3] = 91, \
...
#define EXYNOS7580_TMU_DATA_CL1 \
	.trigger_levels[0] = 76, \
	.trigger_levels[1] = 81, \
	.trigger_levels[2] = 86, \
	.trigger_levels[3] = 91, \
...
#define EXYNOS7580_TMU_DATA_GPU \
	...
	.features = (TMU_SUPPORT_EMULATION | TMU_SUPPORT_TRIM_RELOAD | \
			TMU_SUPPORT_READY_STATUS | TMU_SUPPORT_EMUL_TIME | \
			TMU_SUPPORT_ADDRESS_MULTIPLE),
#endif	/* CONFIG_EXYNOS7580_TMU_DATA_GV */

struct exynos_tmu_init_data const exynos7580_default_tmu_data = {
	.tmu_data = {
#ifdef CONFIG_EXYNOS7580_TMU_DATA_GV
		{ EXYNOS7580_TMU_DATA_CL0 } ,
		{ EXYNOS7580_TMU_DATA_CL1 } ,
#else
		{ EXYNOS7580_TMU_DATA } ,
		{ EXYNOS7580_TMU_DATA } ,
#endif
