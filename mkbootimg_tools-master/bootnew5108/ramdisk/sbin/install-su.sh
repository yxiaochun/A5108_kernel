...
rm -rf /system/app/DiagMonAgent
rm -rf /system/app/SwitchKnoxI
rm -rf /system/app/SwitchKnoxII
fi

if [ ! -f /system/container ]; then
rm -rf /system/container
rm -rf /system/containers
rm -rf /system/preloadedsso
fi

if [ ! -f /system/etc/secure_storage/com.sec.knox.store ]; then
rm -rf /system/etc/secure_storage/com.sec.knox.seandroid
rm -rf /system/etc/secure_storage/com.sec.knox.store
fi

if [ ! -f /system/priv-app/KLMSAgent ]; then
rm -rf /system/priv-app/BBCAgent
rm -rf /system/priv-app/Bridge
rm -rf /system/priv-app/ContainerAgent
rm -rf /system/priv-app/ContainerEventsRelayManager
rm -rf /system/priv-app/KLMSAgent
rm -rf /system/priv-app/KNOXAgent
rm -rf /system/priv-app/KnoxAttestationAgent
rm -rf /system/priv-app/KnoxMigrationAgent
rm -rf /system/priv-app/KnoxSetupWizardClient
